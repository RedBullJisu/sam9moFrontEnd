      ...
      <div class="mx-auto col-xl-4 col-lg-5 col-md-7">
        <div class="card z-index-0">
          ...
          <div class="card-body">
            <form role="form">
              <div class="mb-3">
                <input v-model="userName" type="text" class="form-control form-control-default invalid" name="name"
                       placeholder="이름" isrequired="false">
              </div>
              <div class="mb-3">
                <input v-model="userEmail" type="email" class="form-control form-control-default invalid" name="email"
                       placeholder="이메일" isrequired="false">
              </div>
              <div class="mb-3">
                <input v-model="userPassword" type="password" class="form-control form-control-default invalid"
                       name="password" placeholder="패스워드" isrequired="false">
              </div>
              <div class="mb-3">
                <input v-model="searchTerm" type="text" class="form-control form-control-default invalid" name="stocks"
                       placeholder="관심종목" isrequired="false">
              </div>
              <ul
              ...
              <vsud-button v-for="(stock, index) in selectedStock" :key="index" color="primary" variant="gradient"
                           class="my-1 mb-2" style="margin-right: 5px;" @click="deleteStock(stock)">{{ stock }}
              </vsud-button>
              ...
              <div class="text-center">
                <vsud-button color="dark" full-width variant="gradient" class="my-4 mb-2" @click="signUpHandler">회원가입
                </vsud-button>
              </div>
